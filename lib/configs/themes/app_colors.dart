...
import 'package:tayyari_assignment/configs/themes/ui_parameters.dart';
...
LinearGradient mainGradient(BuildContext context) =>
    UIParameters.isDarkMode(context) ? mainGradientLT : mainGradientLT;
...
Color answerSelectedColor(BuildContext context) =>  Theme.of(context).primaryColor.withOpacity(0.1);
